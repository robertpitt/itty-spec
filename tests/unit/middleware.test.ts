...
describe('withQueryParams', () => {
  ...
  test('withQueryParams should validate query against schema when provided', async () => {
    ...
    expect((request as any).query).toHaveProperty('page');
    expect((request as any).query).toHaveProperty('limit');
  });
...
describe('withHeaders', () => {
  test('withHeaders should normalize Headers object when no schema provided', async () => {
    ...
    expect((request as any).headers).toHaveProperty('Authorization');
...
describe('withBody', () => {
  test('withBody should parse JSON body when schema provided', async () => {
    ...
    expect((request as any).body).toHaveProperty('name');
    expect((request as any).body).toHaveProperty('email');
  });
  ...
  test('withBody should handle already consumed body', async () => {
    ...
    expect((request as any).body).toBeDefined();
  });
})
